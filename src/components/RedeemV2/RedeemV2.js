...
import { getAllDetailsV2 } from "../../Logic/fetchTxnDetailV2";
import { defaultDates } from "../../Logic/defaultDates";
import "../RedeemV1/App.css";
import "../RedeemV1/Box.css"
import Box from "../RedeemV1/Box";

import PendingTableLogicV2 from "../Table_Components/Pending/PendingTableLogicV2"
...
import ReasonsTableLogicV2 from "../Table_Components/Reasons/reasonsTableLogicV2";
...
export function RedeemV2( props ){
  ...
  async function submitHandler() {
    ...
    let arr = await getAllDetailsV2(startEpoch, endEpoch, DB, bitmap);
    // console.log("arr",arr);
      ...
      <div style={{ display: "flex" }}>
        ...
        <div className="table">
          ...
          <div className="inp3">
            ...
            {hidden === 3 && <PendingTableLogicV2 pendingDB = {dataArray[6]} />}
            {hidden === 4 && <ReasonsTableLogicV2 reasonsDB={dataArray[4]} />}
