...
import { getAllDetailsSend } from "../../Logic/fetchTxnDetailSend";
import { defaultDates } from "../../Logic/defaultDates";
import "../RedeemV1/App.css";
import "../RedeemV1/Box.css"
import Box from "../RedeemV1/Box";

import  PendingTableLogicSend  from "../Table_Components/Pending/PendingTableLogicSend";
import UnSuccesfullTableMakerSend from "../Table_Components/unSuccessfull/UnSuccesfullTableMakerSend";
import { SuccesfullTableMakerSend } from "../Table_Components/Sucessfull/SuccesfullTableMakerSend";
import ReasonsTableLogicSend from "../Table_Components/Reasons/ReasonsTableLogicSend";
...
export function Send( props ){
  ...
  async function submitHandler() {
    ...
    let arr = await getAllDetailsSend(startEpoch, endEpoch, DB, bitmap);
    ...
    <div className="App">
      ...
      <div style={{ display: "flex" }}>
        ...
        <div className="table">
          ...
          <div className="inp3">
            {hidden === 1 && SuccesfullTableMakerSend(dataArray[1])}
            {hidden === 2 && UnSuccesfullTableMakerSend(dataArray[3])}
            {hidden === 3 && <PendingTableLogicSend db = {dataArray[6]} />}
            {hidden === 4 && <ReasonsTableLogicSend reasonsDB={dataArray[4]} />}
            {hidden === 5 && UnSuccesfullTableMakerSend(dynamoDB_Prod)}
          </div>
        </div>
      </div>
    </div>
