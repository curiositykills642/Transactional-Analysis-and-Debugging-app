...
function ReasonsTableLogicV2({ reasonsDB }) {
  ...
  function meta_txn_init_failed() {
    setErrorCode("buttons_failedState");
    setfailedState("META_TXN_INIT_FAILED");
  }

  function fiat_init_failed() {
    setErrorCode("buttons_failedState");
    setfailedState("FIAT_INIT_FAILED");
  }
        ...
        {state == "buttons" && (
          <span style={{ marginTop: "10px" }}>
            <span>
              ...
              <button className="m-2 date1 small-font" onClick={meta_txn_init_failed}>
                META_TXN_INIT_FAILED
              </button>
              <button className="m-2 date1 small-font" onClick={fiat_init_failed}>
                FIAT_INIT_FAILED
              </button>
...
export default ReasonsTableLogicV2;
